    ...
    return(
        <main className="flex-1 flex flex-col bg-gray-100 overflow-y-auto gap-5">
            <div className="flex flex gap-1 mx-auto">
                ...
                <Link to="steptwo"  className="bg-gray-600 px-5 py-2 text-white flex flex-col">
                    <p>Step 2.Guardian Information</p>
                </Link>
                <span className="bg-gray-600 px-5 py-2 text-white flex flex-col">
                    <p>Step 3.Education Information</p>
                </span>
                <span  className="bg-gray-600 px-5 py-2 text-white flex flex-col">
