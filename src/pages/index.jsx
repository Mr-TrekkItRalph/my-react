...
return(
    <main className="w-screen h-screen bg-black flex flex-col gap-3"> 
        ...
        <nav className="relative flex bg-black h-auto p-[5px]">
            ...
            <input type="Search" placeholder="Search" className="border-2 rounded-md w-[1090px] text-white"/>
            <div className="w-[400px]"></div>
            <div className="flex justify-evenly items-center w-[400px] divide-x divide-gray-100">
                <Link className="font-serif text-gray-100 pr-10" to="/">Home</Link>
                <Link className="font-serif text-gray-100 pr-10" to="/create-student">Enrollment</Link>
